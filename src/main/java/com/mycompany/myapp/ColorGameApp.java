...
public class ColorGameApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(ColorGameApp.class);

    private final Environment env;

    public ColorGameApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes colorGame.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ColorGameApp.class);
